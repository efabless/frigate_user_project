...
mkdir -p "${PROJECT_ROOT}/signoff/${MACRO}/openlane-signoff/antenna-reports/"
...
# Copy MAG files
cp "${PROJECT_ROOT}/openlane/${MACRO}/runs/${RUN_TAG}/final/mag/${MACRO}.mag" "${PROJECT_ROOT}/mag/${MACRO}.mag"
...
for dir in "${PROJECT_ROOT}/openlane/${MACRO}/runs/${RUN_TAG}/"*"openroad-stapostpnr"*""; do
    cp $dir/summary.rpt "${PROJECT_ROOT}/signoff/${MACRO}/openlane-signoff/timing-reports/summary.rpt"
done

# Copy Antenna check summary report
for dir in "${PROJECT_ROOT}/openlane/${MACRO}/runs/${RUN_TAG}/"*"openroad-checkantennas"*""; do
    cp $dir/reports/antenna_summary.rpt "${PROJECT_ROOT}/signoff/${MACRO}/openlane-signoff/antenna-reports/"
done
